    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headingBar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    fileModel = new FileModel(-1,"recycle file name5","20-09-2023","Document",false);
                }catch (Exception e){
                    fileModel = new FileModel(-1,"Error recycle file","31-05-2020","Document",true);
                }

                DBHelper dbHelper = new DBHelper(RecycleBin.this);
